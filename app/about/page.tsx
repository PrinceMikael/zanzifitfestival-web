...
const TIMELINE = [
  ...
  { year: '2026', label: 'Race weekend', body: 'Inaugural edition, 6-8 November.' },
...
export default function AboutPage() {
  return (
    <main>
      ...
      <section className="mx-auto max-w-6xl px-6 lg:px-36 py-16 md:py-20">
      ...
      <section className="border-t border-border bg-ink py-16 text-bone">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 text-center lg:px-36">
